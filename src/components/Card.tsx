...
const Card = ({ data }: { data: CardProps }) => {
    ...
    return (
        <div className="text-[#EFEFEF] relative overflow-hidden rounded-xl w-full min-w-[200px] max-w-[300px] sm:max-w-[220px] max-h-[340px] cursor-pointer hover-bar-card hover-img-card">
